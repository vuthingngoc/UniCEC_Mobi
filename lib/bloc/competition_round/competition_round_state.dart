...
class CompetitionRoundState extends Equatable {
  ...
  List<TeamModel>? teamsInCompetitionResult;
  ...
  CompetitionRoundState copyWith(
      {List<CompetitionRoundModel>? competitionRoundModel, List<TeamInRoundModel>? teamsInRoundResult, List<TeamModel>? teamsInCompetitionResult}) {
