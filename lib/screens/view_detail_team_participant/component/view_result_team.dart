                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          "Thắng",
                          style: TextStyle(fontSize: 18, color: ArgonColors.success),
                        ),
                      ),
                      ...
                      if (teamInMatch[index].status == TeamInMatchStatus.Draw)
                        Expanded(
                          child: Text(
                            "Hòa",
                            style: TextStyle(fontSize: 18, color: ArgonColors.info),
                          ),
                        ),
                      if (teamInMatch[index].status == TeamInMatchStatus.Cancel)
                        Expanded(
                          child: Text(
                            "Hủy",
                            style: TextStyle(fontSize: 18, color: ArgonColors.muted),
                          ),
                        ),
                      Expanded(
                        child: Container(
