...
class NavbarCompetitionOfClub extends StatefulWidget implements PreferredSizeWidget {
  final String title;
  ...
  @override
  _NavbarCompetitionOfClubState createState() => _NavbarCompetitionOfClubState();
