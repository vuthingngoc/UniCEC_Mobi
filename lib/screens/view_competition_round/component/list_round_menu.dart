...
class ViewListRoundMenu extends StatefulWidget {
  ...
  ViewListRoundMenu({
    Key? key,
    required this.competitionRounds
  }) : super(key: key);
...
class _ViewListRoundMenuState extends State<ViewListRoundMenu> {
  List<CompetitionRoundModel>? get _competitionRounds => widget.competitionRounds;
