...
class AddTeamDialogWithoutLogin extends StatefulWidget {
  AddTeamDialogBloc bloc;
  AddTeamDialogWithoutLogin({required this.bloc});
  @override
  State<AddTeamDialogWithoutLogin> createState() => _AddTeamDialogWithoutLoginState();
}

class _AddTeamDialogWithoutLoginState extends State<AddTeamDialogWithoutLogin> {
