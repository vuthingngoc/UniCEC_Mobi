    ...
    if(model != null){
      return model.map((e) => Container(
          ...
          child: CircleAvatar(
              backgroundImage:
              NetworkImage(
                  "${e.image != "" ? e.image : defaultImage}")))).toList();
    }
    return [];
  }
...
//----------------------------------------------------------------------------Ban giám khảo
                                        ...
                                        element
                                            ...
                                            0)
                                            ? Wrap(
                                              children: getListFluencer(_bloc
                                                  .state
                                                  .competitionDetail
                                                  ?.competitionEntities),
                                            )
                                          ...
                                          child: Container(
                                              ...
                                              //Register time nhưng chưa tham gia
                                                ...
                                                onPressed:
                                                    () {
                                                  _bloc.add(
                                                      ParticipateTheCompetitionEvent(
                                                          competitionId: (state
                                                              .competitionDetail
                                                              ?.id)!));
                                                },
